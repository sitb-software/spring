...
//                data.bodyType(Types.resolve(targetType, targetType, method.getGenericParameterTypes()[i]));
        ...
        return springMvcParseAndValidateMetadata(data, targetType, method);
    }

    private MethodMetadata springMvcParseAndValidateMetadata(MethodMetadata md, Class<?> targetType, Method method) {
